...
class Slider extends Component {
    ...
    show_modal() {
        ...
        Axios.post('/api/get_information_content', { id: this.state.service_name }).then(res => {
            console.log(res);
            // this.setState({
            //     step2_loading: false
            // })
        ...
        window.localStorage.setItem('service',this.state.service_name);
        window.localStorage.setItem('sub_service',this.state.sub_service);
    ...
    residential_cats(data){
        this.setState({
            services_track:0
        },function(){
            this.manage_categories(data)
        })
    }
    seletct_type(val) {
        let subcat = [];
                                ...
                                </div>
                                {
                                    this.state.current_cat != '' ?
                                        <div className="text-center mt-2">
                                            <button onClick={this.residential_cats.bind(this,this.state.all_categories[0])} className="btn btn-light mr-1">Home Services</button>
                                            <button onClick={this.residential_cats.bind(this,this.state.all_categories[1])} className="btn btn-light">Business Services</button>
                                        </div>
                                        : null
                                }
