...
class Create extends Component {
    ...
    createServicePrice(event) {
        ...
        Axios.post('/api/service-price', data, Configs).then(res=>{
            if(res.data.status == 200) {
                toast.success('Create ServicePricing Successfully',{position: "bottom-center"});
            ...
            <div className="row">
                ...
                <div className="panel panel-bordered">
                    ...
                    <div className="panel">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={this.getTitle.bind(this)} type="text" className="form-control" id="title" placeholder="Enter Title" name="title" />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                        ...
                        <button onClick={this.createServicePrice.bind(this)} type="submit" className="btn btn-primary">Submit</button>
                        </div>
                        </form>
                    </div>
                    </div>
