            ...
            <header id="navbar">
                <div id="navbar-container" className="boxed">
                    ...
                    <a href="/admin" className="navbar-brand">
                        ...
                        <span className="brand-text">Tidy Home Admin</span>
                        </div>
                    </a>
                    </div>
                    {/*================================*/}
                    ...
                    <ul className="nav navbar-top-links">
                        ...
                        <div className="dropdown-menu dropdown-menu-md dropdown-menu-right">
                            ...
                            <div className="nano-content">
                                ...
                                <li>
                                    <a className="media" href="#">
                                    <div className="media-left">
                                        <img className="img-circle img-sm" alt="Profile Picture" src="img/profile-photos/9.png" />
                                    </div>
                                    <div className="media-body">
                                ...
                                <li>
                                    <a className="media" href="#">
                                    <div className="media-left">
                                        <img className="img-circle img-sm" alt="Profile Picture" src="img/profile-photos/3.png" />
                                    </div>
                                    <div className="media-body">
                        ...
                        <div className="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                            ...
                            <li onClick={this.logout.bind(this)}>
                                <a><i className="demo-pli-unlock icon-lg icon-fw" /> Logout</a>
                            </li>
                            </ul>
                        </div>
                        </li>
